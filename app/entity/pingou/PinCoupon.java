...
public class PinCoupon implements Serializable {
    ...
    public PinCoupon(Long id, Timestamp memberCouponEndAt, int memberCouponQuota, int masterCoupon, String masterCouponClass, Timestamp masterCouponStartAt, Timestamp masterCouponEndAt, int masterCouponQuota, int memberCoupon, String memberCouponClass, Timestamp memberCouponStartAt) {
        this.id = id;
